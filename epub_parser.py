...
def _classify_item(item_id: str, ncx_label: Optional[str], content: bytes) -> str:
    ...
    # If the text content is very short, it's likely a half-title page,
    # series page, or similar front matter — not a real chapter.
    # Real chapters have substantial prose; half-titles just have the
    # book title, series name, and/or author.
